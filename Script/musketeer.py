...
def initialize():
    try:
        opts, args = getopt.getopt(sys.argv[1:], 'M:hf:t:v:s:Tp:o:v:w:', ['help', 'input_path=', 'output_path=', 'graph_type', 'seed=', 'test', 'params=', 'visualizer=', 'verbose=', 'metrics:'])
...
def show_banner():
    ...
    print '               Multiscale Entropic Network Generator (MUSKETEER)'
...
def show_usage():
    ...
    print 'python musketeer.py -f data-samples/karate.adjlist -t adjlist -p "{\'edge_edit_rate\':[0.1,0.01]}"'
